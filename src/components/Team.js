...
const Team = () => {
    return(
        <div className="flex flex-col items-center  h-screen bg-cover bg-center bg-blue-950">
            <section>
            <div className='max-w-sm rounded overflow-hidden bg-red-950 shadow-xl mt-8'>
                <img className='w-full' src='https://res.cloudinary.com/dxnwbl21t/image/upload/v1688583797/rickbryant_tz70qx.jpg' alt='Rick Bryant in courtroom'></img>
